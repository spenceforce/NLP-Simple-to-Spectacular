...
This book is written entirely in [jupyter notebooks](https://github.com/spenceforce/NLP-Simple-to-Spectacular) so you can run the code. Each chapter lives in it's own directory. A [conda environment file](https://github.com/spenceforce/NLP-Simple-to-Spectacular/blob/main/environment.yml) is provided at the root of the project with everything you need to run each chapter in this book.
